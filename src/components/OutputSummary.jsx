export default function OutputSummary({
  ...
  const metrics = [
    ...
    // ✅ COST in USD
    { label: "Total Cost", value: `${cost} USD` },

    // ✅ DISTANCE in meters
    { label: "Total Distance Travelled", value: `${distance} m` },

    // ✅ TIME in seconds
    { label: "Total Duration", value: `${duration} s` },
    { label: "Driving Time", value: `${driving} s` },
    { label: "Serving Time", value: `${serving} s` },
    { label: "Waiting Time", value: `${waiting} s` },
  ];
